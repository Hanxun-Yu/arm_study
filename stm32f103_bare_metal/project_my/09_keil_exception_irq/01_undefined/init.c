...
void __memcpy(u32* dest, u32* src, u32 len) {
...
void __memset(u32* head, u32 val, u32 len) {
...
void SystemInit(void) {
	...
	if(&Image$$ER_IROM1$$Base != &Load$$ER_IROM1$$Base) {
		__memcpy((u32*)(&Image$$ER_IROM1$$Base),(u32*)(&Load$$ER_IROM1$$Base),(u32)(&Image$$ER_IROM1$$Length));
	}
	
	/* data relocate*/
	if(&Image$$RW_IRAM1$$Base != &Load$$RW_IRAM1$$Base){
		__memcpy((u32*)&Image$$RW_IRAM1$$Base,(u32*)&Load$$RW_IRAM1$$Base,(u32)&Image$$RW_IRAM1$$Length);
	}
	/* clean bss*/
	__memset((u32*)&Image$$RW_IRAM1$$ZI$$Base,0,(u32)&Image$$RW_IRAM1$$ZI$$Length);
}
